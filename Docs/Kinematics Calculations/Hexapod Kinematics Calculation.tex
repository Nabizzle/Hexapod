...
\begin{document}
	...
	\section{Converting Leg Origin to Body Origin}
		\begin{figure}[ht]
			...
			\caption{The top view of the whole body with each leg attachment point labeled with x and y values.}
		\end{figure}
		
		\begin{figure}[ht]
			\centering
			\resizebox{0.95\textwidth}{!}{\incfig{Hexapod Forward Step}}
			\caption{The top view of the whole body when the legs that make the magenta triangle take a forward step.}
		\end{figure}
\end{document}
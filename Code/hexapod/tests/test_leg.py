...
def test_legPos():
    ...
    assert np.allclose(leg.legPos(60, 30, -90, body_model, 1),
                       np.array([[85, 0, 0],
                                 [98.17, 22.81110914, 0],
...
def test_startLegPos():
    ...
    assert np.allclose(leg.startLegPos(body_model, 150, 20),
                       np.array([[60, 63.50456104, -60.47672858],
                                 [0, 63.50456104, -60.47672858],
                                 [-60, 63.50456104, -60.47672858],
                                 [-120, 63.50456104, -60.47672858],
...
def test_legModel():
    ...
    np.array([[[42.5, 85, 42.5, -42.5, -85, -42.5],
              ...
              [[72.66742, 145.3348, 72.66742, -72.66742, -145.3348, -72.66742],
               [125.863668, 0, -125.863668, -125.863668, 0, 125.863668],
               [68.19670, 68.19670, 68.19670, 68.19670, 68.19670, 68.19670]],
...
def test_getFeetPos():
    ...
    leg_model = np.array([[[42.5, 85, 42.5, -42.5, -85, -42.5],
                           [73.61216, 0, -73.61216, -73.61216, 0, 73.61216],
                           [0, 0, 0, 0, 0, 0]],

                          [[55.67, 111.34,  55.67, -55.67, -111.34, -55.67],
                           [96.42327, 0, -96.42327, -96.42327, 0, 96.42327],
                           [0, 0, 0, 0, 0, 0]],

                          [[72.667, 145.34, 72.667, -72.667, -145.34, -72.667],
                           [125.8637, 0, -125.8637, -125.8637, 0, 125.8637],
                           [68.197, 68.197, 68.197, 68.197, 68.197, 68.197]],

                          [[75, 150, 75, -75, -150, -75],
                           [129.9038, 0, -129.9038, -129.9038, 0, 129.9038],
                           [-20, -20, -20, -20, -20, -20]]])

    assert np.allclose(leg.getFeetPos(leg_model),
                       np.array([[75, 129.903811, -20],
                                 [150, 0, -20],
                                 [75, -129.903811, -20],
                                 [-75, -129.903811, -20],
                                 [-150, 0, -20],
